...
/**
 * Канал получения релизов BSL Language Server.
 */
public enum BslLanguageServerReleaseChannel {

  /**
   * Только стабильные релизы (последний релиз, не помеченный как pre-release).
   */
  STABLE,

  /**
   * Любой последний релиз, включая pre-release.
   */
  PRERELEASE
}
